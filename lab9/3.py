...
def draw_shape(start_pos, end_pos):
    if shape == 'rectangle':
        ...
        pygame.draw.rect(screen, colorRed, (start_pos[0], start_pos[1], max_dim, max_dim), Thickness)
    elif shape == 'right_triangle':
        pygame.draw.polygon(screen, colorRed, [(start_pos[0], start_pos[1]), (end_pos[0], end_pos[1]), (start_pos[0], end_pos[1])], Thickness)
    elif shape == 'equilateral_triangle':
        half_width = abs(end_pos[0] - start_pos[0]) // 2
        height = int(half_width * math.sqrt(3))
        pygame.draw.polygon(screen, colorRed, [(start_pos[0], start_pos[1] + height), (start_pos[0] + half_width, start_pos[1]), (end_pos[0], end_pos[1])], Thickness)
    elif shape == 'rhombus':
        pygame.draw.polygon(screen, colorRed, [(start_pos[0], (start_pos[1] + end_pos[1]) // 2), ((start_pos[0] + end_pos[0]) // 2, start_pos[1]), (end_pos[0], (start_pos[1] + end_pos[1]) // 2), ((start_pos[0] + end_pos[0]) // 2, end_pos[1])], Thickness)
